...
public class FacturierResourceIntTest {
    ...
    public void setup() {
        ...
        final FacturierResource facturierResource = new FacturierResource(facturierService);
    ...
    public void createFacturier() throws Exception {
        ...
        assertThat(testFacturier.getLibelle()).isEqualTo(DEFAULT_LIBELLE);
        assertThat(testFacturier.getCode()).isEqualTo(DEFAULT_CODE);
        assertThat(testFacturier.getNumeroCompte()).isEqualTo(DEFAULT_NUMERO_COMPTE);
        assertThat(testFacturier.isDeleted()).isEqualTo(DEFAULT_DELETED);
    }
    ...
    public void checkLibelleIsRequired() throws Exception {
        int databaseSizeBeforeTest = facturierRepository.findAll().size();
        // set the field null
        facturier.setLibelle(null);

        // Create the Facturier, which fails.
        ...
        List<Facturier> facturierList = facturierRepository.findAll();
        assertThat(facturierList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void checkNumeroCompteIsRequired() throws Exception {
        int databaseSizeBeforeTest = facturierRepository.findAll().size();
        // set the field null
        facturier.setNumeroCompte(null);
    ...
    public void updateFacturier() throws Exception {
        // Initialize the database
        facturierService.save(facturier);
        ...
        Facturier testFacturier = facturierList.get(facturierList.size() - 1);
        assertThat(testFacturier.getLibelle()).isEqualTo(UPDATED_LIBELLE);
        assertThat(testFacturier.getCode()).isEqualTo(UPDATED_CODE);
        assertThat(testFacturier.getNumeroCompte()).isEqualTo(UPDATED_NUMERO_COMPTE);
        assertThat(testFacturier.isDeleted()).isEqualTo(UPDATED_DELETED);
    }
