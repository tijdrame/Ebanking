...
import { StatutDialogComponent } from '../../../../../../main/webapp/app/entities/statut/statut-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Statut Management Dialog Component', () => {
        let comp: StatutDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(StatutDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'statutListModification', content: 'OK'});
