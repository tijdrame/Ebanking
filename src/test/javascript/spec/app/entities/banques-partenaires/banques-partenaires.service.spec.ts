...
describe('Service Tests', () => {
    ...
    describe('BanquesPartenaires Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BanquesPartenairesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/banques-partenaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BanquesPartenaires', () => {
