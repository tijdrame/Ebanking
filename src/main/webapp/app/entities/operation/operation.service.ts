...
export class OperationService {
    ...
    private convertItemFromServer(operation: Operation): Operation {
        ...
        copy.dateOperation = this.dateUtils
            .convertLocalDateFromServer(operation.dateOperation);
        copy.dateAcceptation = this.dateUtils
            .convertLocalDateFromServer(operation.dateAcceptation);
        copy.dateExecution = this.dateUtils
            .convertLocalDateFromServer(operation.dateExecution);
        return copy;
    }
    ...
    private convert(operation: Operation): Operation {
        const copy: Operation = Object.assign({}, operation);
        copy.dateOperation = this.dateUtils
            .convertLocalDateToServer(operation.dateOperation);
        copy.dateAcceptation = this.dateUtils
            .convertLocalDateToServer(operation.dateAcceptation);
        copy.dateExecution = this.dateUtils
            .convertLocalDateToServer(operation.dateExecution);
        return copy;
    }
}
