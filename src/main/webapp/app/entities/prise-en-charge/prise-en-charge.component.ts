...
currentAccount: any;
    ...
    loadAll() {
        this.priseEnChargeService.query({
            ...
            sort: this.sort()}).subscribe(
                (res: HttpResponse<PriseEnCharge[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/prise-en-charge'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: PriseEnCharge) {
        return item.id;
    }
